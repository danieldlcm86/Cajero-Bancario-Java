...
public class GeneradorAleatorioDeMovimientos {
    ...
    private static final String NOMINA = "Ingreso de nómina de ";
    private static final String PAGO_RECIBIDO = "Pago de recibo de ";
        ...
        for (int i = 0; i < numeroDeMovimientos; i++) {
            ...
            switch (numeroDeMovimiento){
                ...
                case 5:
                    ...
                    break;
                default:
                    tipoDeMovimiento = PAGO_RECIBIDO;
            }
